...
""",
    ...
    # registerbf command #
    ################
    parser_registerbf = subparsers.add_parser(
        "registerbf",
        formatter_class=argparse.RawTextHelpFormatter,
        help="brutforce a customized message",
        add_help=False,
        description=RED
...
""",
    ...
    target = parser_registerbf.add_argument_group("Target")
    target.add_argument(
        "-i",
        metavar="IP|HOST",
        type=str,
    ...
    headers = parser_registerbf.add_argument_group("Headers")
    headers.add_argument(
        "-m",
        metavar="METHOD",
        type=str,
    ...
    auth = parser_registerbf.add_argument_group("Auth")
    auth.add_argument(
        "-user",
        metavar="AUTH_USER",
        type=str,
    ...
    log = parser_registerbf.add_argument_group("Log")
    log.add_argument(
        "-v", help="Increase verbosity", dest="verbose", action="count"
    )
    log.add_argument(
    ...
    other = parser_registerbf.add_argument_group("Other options")
    other.add_argument(
        "-t",
        metavar="TIMEOUT",
        type=int,
...
""",
  ...
  Module """
    ...
    elif COMMAND == "registerbf":
        if args.help == 1:
            parser_registerbf.print_help()
            exit()
        if not args.ipaddr:
            parser_registerbf.print_help()
            print(RED)
